...
Worry not! We've finally reached the part where I present a method for finding "The Best" (or "The Better", at least).
A visulization for "The Best". It is inspired by (more like entirely ripped off from) [this](https://fivethirtyeight.com/features/kawhi-leonard-is-the-most-well-rounded-elite-shooter-since-larry-bird/) FiveThirtyEight article.
...
Moving to the Pokemon question we can grab data from [http://pokemondb.net/](http://pokemondb.net/)
